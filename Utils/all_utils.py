...
def save_model(model, filename):
    model_dir = "models"
    os.makedirs(model_dir, exist_ok=True) #only create if model directory doesnot exits
...
def save_plot(df,file_name,model):
    ...
    plot_dir="plots"
    os.makedirs(plot_dir, exist_ok=True) #only create if model directory doesnot exits
